...
int main( int argc, char** argv )
{
  // 1. Read Input Image
	...
	// 4. Save Result Image
	std::string imageOutName = "subtask2/detectedDartboard-";
...
void detectAndDisplay( Mat frame, char*name)
{
  ...
  //4. Draw box around faces found
	...
	// cout << "Number of dartboards (ground truth): " << numrect << endl;
	// cout << "Number of dartboards detected correctly (true positives): " << truePositives << endl;
	// cout << "Number of dartboards detected correctly (true positives): " << truePositives << endl;
	...
	// cout << "Number of dartboards detected (positves): " << numberOfPositives << endl;
